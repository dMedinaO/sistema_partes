...
<head>
    ...
    <script src="../controllers/parte_controller/controller_validator.js"></script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Generador de Partes</h1>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                          <form id="newParte" method="post" class="form-horizontal form-label-left">
  
                            <div class="form-group">
                               <label class="col-sm-3 control-label">Seleccione la repartición*</label>
                                <div class="col-sm-5">
                           ...
                           <div class="form-group">
                            <label class="col-sm-3 control-label">Forman</label>
                             <div class="col-sm-5">
                                 <input type="text" class="form-control" id="forman" name="forman" />
                             </div>
                         </div>                         
                            ...
                            <div class="form-group">
                                <div class="col-sm-5 col-sm-offset-3">
                                  <button id="process_parte" class="btn btn-primary">Crear nuevo parte</button>
                                </div>
                            </div>
                          </form>
                          ...
                          <div class="col-sm-12 col-md-12 col-lg-12" id="errorResponse" style="display:none;">
                            <div class="alert alert-danger" role="alert">
                              Error durante la creación del parte, por favor, revisar los datos. En caso de persistencia comunicarse con los encargados del sistema.
                            </div>
                          </div>
